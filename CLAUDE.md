...
- `src/mcp/server.ts` - MCP server with 30+ tools across events, registrations, speakers, sessions, abstracts, hotels, media; stdio transport (launched via `src/mcp/start.sh` for local dev)
