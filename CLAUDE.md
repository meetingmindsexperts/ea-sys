...
- `src/lib/agent/tools/accommodations.ts` - accommodations + hotels: `list_hotels`, `create_hotel`, `list_accommodations`, `list_room_types`, `create_accommodation` (atomic overbooking guard), `update_accommodation_status`.
