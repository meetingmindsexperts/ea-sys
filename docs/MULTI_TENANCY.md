...
- **Core event domains** — Speaker, Abstract, Sessions/Tracks, Hotels/Accommodation, Certificates, Survey, RSVP, Reimbursement, EmailLog/ScheduledEmail, HelpChatQuery, AuditLog (needs a flat org column). Registration-core + ticketing + finance + CRM + webinar are done.
