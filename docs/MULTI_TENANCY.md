...
- **Core event domains** — Abstract, Sessions/Tracks, Certificates, Survey, RSVP, Reimbursement, EmailLog/ScheduledEmail, HelpChatQuery, AuditLog (needs a flat org column). Registration-core + ticketing + finance + CRM + webinar + Speaker + **Accommodation** are done.
