...
If you're returning to this doc after a gap, these are the significant features that landed between April 2 and June 23 and may not be fully reflected in every section below. The deltas are called out inline where relevant, and `CLAUDE.md` is the canonical log.
