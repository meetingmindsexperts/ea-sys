  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        {file.type === "markdown" ? (
          <div className="prose prose-sm dark:prose-invert max-w-none p-6 prose-headings:scroll-mt-4 prose-pre:text-xs prose-code:text-xs prose-code:bg-muted prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-table:text-xs">
