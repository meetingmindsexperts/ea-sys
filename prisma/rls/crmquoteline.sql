-- Row-Level Security policy: CrmQuoteLine (CRM quote editor, Sep 15 2026). Same shape and
...
ALTER TABLE "CrmQuoteLine" ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS crmquoteline_tenant_isolation ON "CrmQuoteLine";
CREATE POLICY crmquoteline_tenant_isolation ON "CrmQuoteLine"
  FOR ALL TO PUBLIC
