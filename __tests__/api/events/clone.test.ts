    ...
    ticketTypes: [
      {
        ...
        pricingTiers: [
          { name: "Early Bird", price: 80, currency: "USD", quantity: 200, soldCount: 50, maxPerOrder: 5, salesStart: null, salesEnd: null, isActive: true, requiresApproval: false, sortOrder: 0 },
          { name: "Standard", price: 100, currency: "USD", quantity: 300, soldCount: 150, maxPerOrder: 5, salesStart: null, salesEnd: null, isActive: true, requiresApproval: false, sortOrder: 1 },
        ],
      },
      {
        id: "tt-2",
